...
const Navbar=({theme,setTheme})=>{
    ...
    return(
        ...
        xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white">
            ...
            max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-gray max-sm:pt-20 flex sm:items-center gap-5 transition-all">
            ...
            <div>
                ...
                px-6 py-2 rounded-full cursor-pointer hover:scale-103 transition-all  bg-indigo-500">
