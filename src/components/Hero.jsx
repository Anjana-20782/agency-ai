...
import assets from "../assets/assets";
  ...
  const Hero=()=>{
     return(
        <div id="hero" className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24  xl:p-25 text-center
         w-full overflow-hidden text-gray-400 dark:text-white">

            <div className="inline-flex items-center gap-2 border border-gray-300 p-1.5 pr-4 rounded-full">
                <img className="w-20" src={assets.group_profile} alt="" />
                <p className="text-xs font-bold">Trusted By 10K People</p>
            </div>
